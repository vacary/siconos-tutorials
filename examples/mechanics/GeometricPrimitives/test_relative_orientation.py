...
with MechanicsHdf5Runner() as io:
    ...
    io.add_object(
        "cyl_rel_rot_1",
        [Contactor("Cyl", relative_orientation=orientation_rot_x)],
    ...
    io.add_object(
        "cyl_rot_3",
        [Contactor("Cyl")],
        translation=[3, 0, (L / 2.0 - 0.1) * math.cos(math.pi / 4.0)],
        orientation=orientation_rot_x,
        velocity=[0, 0, 0, 0, 0, 0],
        mass=1,
        inertia=inertia_test,
    ...
    io.add_object(
        ...
        translation=[
            3,
            L * math.cos(math.pi / 4.0),
            (L / 2.0 + L - 0.1) * math.cos(math.pi / 4.0),
        ],
        orientation=orientation_rot_x,
        velocity=[0, 0, 0, 0, 0, 0],
        mass=1,
    ...
    io.add_object(
        "cyl_rel_rot_3",
        [Contactor("Cyl", relative_orientation=orientation_rot_x)],
        translation=[2, 0, (L / 2.0 - 0.1) * math.cos(math.pi / 4.0)],
        # orientation= orientation_rot_x,
        velocity=[0, 0, 0, 0, 0, 0],
        mass=1,
        inertia=inertia_test,
    ...
    io.add_object(
        "cyl_rot_5",
        [Contactor("Cyl", relative_orientation=orientation_rot_z)],
        translation=[6, 0, 0.1],
        orientation=orientation_rot_x,
        velocity=[0, 0, 0, 0, 0, 0],
        mass=1,
    ...
    io.add_object(
        "cyl_rot_9",
        [Contactor("Cyl")],
        translation=[10, 0, (L / 2.0 - 0.1) * math.cos(math.pi / 4.0)],
        orientation=orientation_rot_x,
        velocity=[0, 0, 0, 0, 0, 0],
        mass=1,
        inertia=inertia_test,
    ...
    io.add_object(
        "cyl_rel_rot_9",
        [Contactor("Cyl", relative_orientation=orientation_rot_x)],
        translation=[11, 0, (L / 2.0 - 0.1) * math.cos(math.pi / 4.0)],
        # orientation= orientation_rot_x,
        velocity=[0, 0, 0, 0, 0, 0],
        mass=1,
        inertia=inertia_test,
    ...
    io.add_object(
        ...
        [
            Contactor(
                "Cyl",
                relative_translation=[-0.5, 0, 0],
                relative_orientation=orientation_rot_x,
            ),
            Contactor(
                "Cyl",
                relative_translation=[0.5, 0, 0],
        ...
        translation=[12, 0, (L / 2.0 - 0.1) * math.cos(math.pi / 4.0)],
        # orientation= orientation_rot_x,
        velocity=[0, 0, 0, 0, 0, 0],
        mass=1,
        inertia=inertia_test,
    ...
    io.add_object(
        ...
        translation=[14, 0, (L / 2.0 - 0.1) * math.cos(math.pi / 4.0)],
        orientation=orientation_rot_x,
        velocity=[0, 0, 0, 0, 0, 0],
        mass=1,
        inertia=inertia_test,
    ...
    # detection.
    io.add_object("ground", [Contactor("Ground")], translation=[9, 0, -0.7])
