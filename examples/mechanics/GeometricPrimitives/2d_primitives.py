...
with MechanicsHdf5Runner() as io:
    ...
    io.add_primitive_shape(
        "Disk", "Disk", (disk_radius,), insideMargin=0.0, outsideMargin=0.0
    )
    ...
    inertia = 1 / 2.0 * mass * disk_radius**2
    io.add_object(
        "disk",
        [Contactor("Disk")],
        translation=[0, 5.0],
    ...
    # Definition of a box
    io.add_primitive_shape(
        "Box", "Box2d", (box_height, box_width), insideMargin=0.0, outsideMargin=0.0
    )

    mass = density * box_height * box_width
    inertia = 1 / 12.0 * mass * (box_height**2 + box_width**2)
    io.add_object(
        "box",
        [Contactor("Box")],
        translation=[0, 7.0],
    ...
    vertices = np.array([[0.0, 0.0], [2.0, 0.0], [0, 2.0]])
    ...
    vertices = [[0.0, 0.0], [2.0, 0.0], [0, 2.0], [1, 3.0], [3, 2.0]]
    ...
    io.add_primitive_shape(
        "Ground", "Box2d", (15, 1), insideMargin=0.0, outsideMargin=0.0
    )
