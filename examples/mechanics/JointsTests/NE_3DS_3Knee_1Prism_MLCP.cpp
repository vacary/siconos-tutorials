...
int main(int argc, char *argv[]) {
  try {
    ...
    for (k = 0; k < N; k++) {
      ...
      // std::cout <<"s->getNewtonCumulativeNbIterations  for step k " << k<< "  = " <<
      // s->getNewtonCumulativeNbIterations() <<std::endl;
    }
    ...
    siconos::algebra::io::write("NE_3DS_3Knee_1Prism_MLCP.dat", dataPlot,
