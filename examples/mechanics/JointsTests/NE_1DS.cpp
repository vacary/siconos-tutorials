...
int main(int argc, char *argv[]) {
  try {
    ...
    siconos::algebra::io::write("NE_1DS.dat", dataPlot, siconos::algebra::io::ASCII_OUT,
                                siconos::algebra::io::WriteType::nodim);
    siconos::algebra::io::write("NE_1DS_beam1.dat", beam1Plot, siconos::algebra::io::ASCII_OUT,
                                siconos::algebra::io::WriteType::nodim);
    double error = 0.0, eps = 1e-12;
    if ((error = siconos::algebra::io::compareRefFile(dataPlot, "NE_1DS.ref", eps)) >= eps)
      return 1;
