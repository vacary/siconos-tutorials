...
config_occ = siconos.io.mechanics_run.RunnerConfig()
config_occ.set_backend("occ")

# ball shape
ball = BRepPrimAPI_MakeSphere(0.15).Shape()
...
print("ball center of mass:", (ball_com.Coord(1), ball_com.Coord(2), ball_com.Coord(3)))
print("ball moment of inertia:", (ball_I1, ball_I2, ball_I3))

# the ground
ground = BRepPrimAPI_MakeBox(gp_Pnt(-20, -20, 0), 40.0, 40.0, 0.5).Shape()

# bowl shape
hspherei = BRepPrimAPI_MakeSphere(0.9, pi).Shape()
hsphereo = BRepPrimAPI_MakeSphere(1.0, pi).Shape()
...
print("bowl center of mass:", (bowl_com.Coord(1), bowl_com.Coord(2), bowl_com.Coord(3)))
...
with MechanicsHdf5Runner(config=config_occ) as io:
    ...
    io.add_object(
        ...
        center_of_mass=[bowl_com.Coord(1), bowl_com.Coord(2), bowl_com.Coord(3)],
    ...
    io.add_object(
        ...
        [
            Contactor(
                "Ball", instance_name="Ball1", contact_type="Face", contact_index=0
            )
        ],
        translation=[0, 0.3, 2],
        mass=0.1,
    ...
    io.add_object(
        ...
        [
            Contactor(
                "Ball", instance_name="Ball2", contact_type="Face", contact_index=0
            )
        ],
        translation=[0, 0, 2],
        mass=0.1,
    ...
    io.add_object(
        ...
        [
            Contactor(
                "Ball", instance_name="Ball3", contact_type="Face", contact_index=0
            )
        ],
        translation=[0, -0.3, 2],
        mass=0.1,
...
options.dparam[sn.params.SICONOS_DPARAM_TOL] = 1e-7
