...
if not restart:
    with MechanicsHdf5Runner(config=config_occ) as io:
        ...
        if use_cylinder_as_stops:
            ...
            #                             'BackCover.step')
            step_file = Path(step_dir, "BackCover_Contactor_face21.step").as_posix()
            io.add_shape_data_from_file("back_cover_contactorA_shp", step_file)
            step_file = Path(step_dir, "BackCover_Contactor_face213.step").as_posix()
        ...
        inertia = [0.019661740055950054, 0.028171281786527207, 0.021165152882136887]
        init_orientation = [0.97366047, 0.0, 0.0, -0.22800273]  #

        angle_init = math.asin(-0.22800273)
        print("angle_init =", angle_init)
        angle_init = math.pi / 4.0
        init_orientation = [math.sin(angle_init), 0.0, 0.0, math.cos(angle_init)]

        io.add_object(
            "balance_wheel_body",
            [
                Volume(
                    shape_name="balance_wheel_shp",
                    instance_name="balance_wheel_shp_bdy",
        ...
        pin_lever_shapes.extend(
            [
                Contactor(
                    instance_name="pin_lever_contactorA_shp_f1",
                ...
                Contactor(
                    instance_name="pin_lever_contactorB_shp_f0",
        ...
        pin_lever_shapes.extend(
            [
                Contactor(
                    instance_name="pin_lever_shp_f45",
                    shape_name="pin_lever_shp",
                    contact_type="Face",
                    contact_index=45,
                    relative_translation=-1.0 * pin_lever_com,
                ...
                Contactor(
                    instance_name="pin_lever_shp_f43",
                    shape_name="pin_lever_shp",
                    contact_type="Face",
                    contact_index=43,
                    relative_translation=-1.0 * pin_lever_com,
        ...
        pin_lever_shapes.extend(
            [
                Contactor(
                    instance_name="pin_lever_shp_f39",
                    shape_name="pin_lever_shp",
                    contact_type="Face",
                    contact_index=39,
                    relative_translation=-1.0 * pin_lever_com,
                ...
                Contactor(
                    instance_name="pin_lever_shp_f12",
                    shape_name="pin_lever_shp",
                    contact_type="Face",
                    contact_index=12,
                    relative_translation=-1.0 * pin_lever_com,
        ...
        offset = 0.01
        io.add_interaction(
            "contact_balance_wheel_pin_lever_10",
            body1_name="balance_wheel_body",
            contactor1_name="balance_wheel_contactor_shp_f0",
        ...
        io.add_interaction(
            "contact_balance_wheel_pin_lever_11",
            body1_name="balance_wheel_body",
            contactor1_name="balance_wheel_contactor_shp_f0",
            body2_name="pin_lever_body",
        ...
        io.add_interaction(
            "contact_balance_wheel_pin_lever_20",
            body1_name="balance_wheel_body",
            contactor1_name="balance_wheel_contactor_shp_f1",
            body2_name="pin_lever_body",
            contactor2_name="pin_lever_shp_f45",
            distance_calculator="cadmbtb",
            offset1=offset,
        ...
        io.add_interaction(
            "contact_balance_wheel_pin_lever_21",
            body1_name="balance_wheel_body",
            contactor1_name="balance_wheel_contactor_shp_f1",
            body2_name="pin_lever_body",
            contactor2_name="pin_lever_shp_f43",
        ...
        for c in list_contactor:
            ...
            io.add_interaction(
                "contact_escape_wheel_pin_lever_" + str(counter),
                body1_name="escape_wheel_body",
                contactor1_name=c.instance_name,
                body2_name="pin_lever_body",
        ...
        if use_cylinder_as_stops:
            offset = 0.01
            io.add_interaction(
                "contact_pin_lever_stops_0",
                body1_name="pin_lever_body",
                contactor1_name="pin_lever_shp_f39",
                body2_name="pin_lever_stops_static",
                contactor2_name="pin_lever_stopsA_shp_f0",
                distance_calculator="cadmbtb",
                offset1=offset,
            )

            io.add_interaction(
                "contact_pin_lever_stops_1",
                body1_name="pin_lever_body",
                contactor1_name="pin_lever_shp_f12",
                body2_name="pin_lever_stops_static",
                contactor2_name="pin_lever_stopsB_shp_f0",
                distance_calculator="cadmbtb",
                offset1=offset,
            )
        else:
            offset = 0.05
            io.add_interaction(
                "contact_back_cover_pin_lever_0",
                body1_name="back_cover_static",
                contactor1_name="back_cover_contactor_shp_f212",
                body2_name="pin_lever_body",
            ...
            io.add_interaction(
                "contact_back_cover_pin_lever_1",
                body1_name="back_cover_static",
                contactor1_name="back_cover_contactor_shp_f213",
                body2_name="pin_lever_body",
