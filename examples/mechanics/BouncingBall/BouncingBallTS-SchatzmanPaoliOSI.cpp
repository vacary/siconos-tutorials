...
int main(int argc, char *argv[]) {
  try {
    ...
    double theta = 0.5;          // theta for integrator
    ...
    auto OSI = std::make_shared<siconos::integrators::SchatzmanPaoliOSI>(theta);
    ...
    if ((error = siconos::algebra::io::compareRefFile(dataPlot, "BouncingBallTS-SchatzmanPaoliOSI.ref", eps)) >= eps)
      return 1;
  }
