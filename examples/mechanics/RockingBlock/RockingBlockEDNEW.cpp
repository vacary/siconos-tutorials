...
int main(int argc, char* argv[]) {
  ...
  try {
    ...
    */
    ...
    0.5*HeightBlock*cos(AngleThetaIni))*RotVelBlockIni;
    (*VelIniBlock)(1) = VelYiniPointA + (0.5*LengthBlock*cos(AngleThetaIni) -
    0.5*HeightBlock*sin(AngleThetaIni))*RotVelBlockIni;
    ...
    */
    ...
    siconos::algebra::print(*ForceExtern);
    //==================================================================================================================
    ...
    siconos::algebra::io::write("resultNEW.dat", DataPlot, siconos::algebra::io::ASCII_OUT,
                                siconos::algebra::io::WriteType::nodim);
    double error = 0.0, eps = 1e-12;
    if ((error = siconos::algebra::io::compareRefFile(DataPlot, "resultNEW.ref", eps)) > eps)
      return 1;
    return 0;
  }
  //============================== Catch exceptions
