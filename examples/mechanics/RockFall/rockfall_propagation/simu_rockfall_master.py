...
parser.add_argument(
    "--output",
    type=str,
    default="run_default_master.hdf5",
...
options.iparam[sn.SICONOS_IPARAM_MAX_ITER] = np_solv_iter_max
options.dparam[sn.SICONOS_DPARAM_TOL] = np_solv_tol
...
run_options["Newton_options"] = (
    sk.SICONOS_TS_NONLINEAR
)  # WARNING : BEFORE IT WAS "LINEAR"
...
run_options["osi"] = sk.MoreauJeanOSI
