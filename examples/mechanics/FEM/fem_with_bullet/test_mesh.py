...
mesh_filename = "tetra.stl"
mesh_filename = "cube.stl"
...
with MechanicsHdf5Runner() as io:
    ...
    io.add_mesh_from_file('Mesh', mesh_filename, scale=0.5,
    ...
    for i in range(n_object):
        io.add_object('mesh%d' % i, [Contactor('Mesh', relative_translation = [-0.25, -0.25, -.25])],
                      translation=[0.5, 0.5, 0.5+i],
                      orientation=[math.cos(angle/2.), math.sin(angle/2.), 0, 0],
