...
double position_init = 0.0;   // initial position of the ball
double velocity_init =  -4.472;    // initial velocity of the ball
...
double I = 8.64e-6;    // Moment of inertia
double S = 3.4e-3;           // Beam Section 
double L = 3.0;                 // length of the  beam
double rho = 7701.0 ;           // specific mass
//rho=1.0;
double g = 9.81;                // Gravity
//g=0.0;
double e = 0.0;

double ball_mass = 250.0;
