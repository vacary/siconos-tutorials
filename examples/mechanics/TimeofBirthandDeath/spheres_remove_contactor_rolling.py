        ...
        if contact_points is not None:
            ...
            for cp in contact_points:
                ...
                if ds1_id == ds2_id:
                    ...
                    for contactor in contact_r.bodyShapeRecordB.staticBody.contactors():
                        print(
                            "contact_r.bodyShapeRecordB.staticBody.contactor shape ",
                            contactor.shape,
                        )
                    print(
