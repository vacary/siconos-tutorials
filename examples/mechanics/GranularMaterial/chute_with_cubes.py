...
with MechanicsHdf5Runner(use_compression=True) as io:
    ...
    io.add_object("left_up", [Contactor("Left_up")], translation=[0, 0, 0])
    ...
    io.add_object("left_middle", [Contactor("Left_middle")], translation=[0, 0, 0])

    # left_down
    id_plan = id_plan + 1
    body_collection["plan_id"]["left_down"] = id_plan

    v6 = numpy.array([4.370, box_width, -0.6])
    v7 = numpy.array([6.900 - 1.770, box_width, -0.6])
    ...
    io.add_object("left_udown", [Contactor("Left_down")], translation=[0, 0, 0])
    ...
    io.add_object("right_up", [Contactor("Right_up")], translation=[0, 0, 0])
    ...
    io.add_object("rear_up", [Contactor("Rear_up")], translation=[0, 0, 0])
    ...
    io.add_object("rear_down", [Contactor("Rear_down")], translation=[0, 0, 0])
    ...
    io.add_object("front_up", [Contactor("Front_up")], translation=[0, 0, 0])
    ...
    io.add_object("front_down", [Contactor("Front_down")], translation=[0, 0, 0])
        ...
        for j in range(n_col):
            for n in range(n_cube):
                ...
                io.add_object(
                    ...
                    translation=[
                        2 + i * x_shift * cube_size,
                        2 + x_shift * j * cube_size,
                        3 + cube_size * x_shift * n,
                    ],
