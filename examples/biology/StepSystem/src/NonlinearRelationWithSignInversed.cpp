...
user_defined::NonlinearRelation::NonlinearRelationWithSignInversed.() : FirstOrderType2R{} {
...
void user_defined::NonlinearRelation::NonlinearRelationWithSignInversed.::initialize(
    Interaction& inter) {
