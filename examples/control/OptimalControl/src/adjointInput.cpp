...
/*y = h(X,lambda)*/
void user_defined::adjointInput::computeh(double t, const siconos::algebra::BlockVector &x,
...
void user_defined::adjointInput::computeg(double t, const siconos::algebra::BlockVector &x,
                                          const siconos::algebra::SiconosVector &lambda,
                                          siconos::algebra::BlockVector &z,
...
void user_defined::adjointInput::beta(double t, const siconos::algebra::BlockVector &xvalue,
                                      std::shared_ptr<siconos::algebra::SiconosVector> beta) {
