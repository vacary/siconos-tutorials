...
int main(int argc, char* argv[]) {
  ...
  // Dynamical Systems
  auto plant = std::make_shared<siconos::modeling::FirstOrderNonLinearDS>(
      x0, "electro_pneumatic_nantesPlugin:computef",
      "electro_pneumatic_nantesPlugin:computeJacfx");
  plant->setzPtr(param);
